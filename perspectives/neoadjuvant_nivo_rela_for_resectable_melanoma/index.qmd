...
author: "David M. Miller^1^^,^^2^, Howard L. Kaufman^2^^,^^3^, Kevin S. Emerick^2^^,^^4^, Justine V. Cohen^5^, Emily Y Kim^6^, Sophia Z. Shalhout^1^^,^^2^,"
date: 2022-12-05
format: html   
link-citations: yes
csl: https://raw.githubusercontent.com/citation-style-language/styles/master/nature.csl
bibliography: bibliography.bibtex 
image: files/december_2022/featured.jpg
description: In this `Perspectives on the Science` piece we reflect on the impact of the recently published article "Neoadjuvant relatlimab and nivolumab in resectable melanoma".
categories: [2022, Melanoma, Neoadjuvant, Nivo/Rela] 
---
...
5.  Pennsylvania Hospital and University of Pennsylvania, Philadelphia PA
