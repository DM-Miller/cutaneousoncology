...
<style>
  /* =========================================================
     Journal Club — editorial refresh
     Uses the established SoCO palette from theme.scss
     ========================================================= */
  ...
  .soco-jc-hero-inner {
    ...
    background:
      ...
      radial-gradient(circle at 12% 86%, rgba(255, 59, 63, 0.07), transparent 30%),
...
::: {.soco-eyebrow}
August 2026 · Current discussion
:::

## Frontline Immunotherapy with Response-Guided Subsequent Treatment (FIRST) in Cutaneous Squamous Cell Carcinoma

::: {.soco-jc-citation}
Miller DM, Merkin RD, Kaufman HL, Gupta SG, Wolkow N, Adelaja A, Sullivan RJ, Patel C, Sorrentino A, Cohen S, Cimoch C, Emerick KS. *Journal for ImmunoTherapy of Cancer.* 2026;14(7):e015029. doi:10.1136/jitc-2026-015029.
:::
...
This retrospective cohort study evaluated 189 patients with resectable, borderline-resectable, locally advanced, or limited metastatic cutaneous squamous cell carcinoma treated with immune checkpoint inhibition between 2019 and 2025. The analysis focused on a deceptively simple clinical question: **how much immunotherapy is enough, and what should happen after a deep response?**

::: {.soco-jc-question}
[The question beneath the paper]{.soco-jc-question-label}

Can early response help determine how much additional systemic therapy—or local consolidation—a patient actually needs?
:::
...
How should we interpret outcomes when the number of doses received is not randomly assigned and is itself influenced by response, toxicity, and clinical circumstance?
:::

::: {.soco-jc-discussion-card}
Causal inference

What do Bayesian adjustment and posterior probabilities add when trying to learn from response-guided treatment patterns in observational data?
:::

::: {.soco-jc-discussion-card}
De-escalation

When a patient has already achieved a deep response, how persuasive is the evidence that additional treatment or consolidation changes outcome?
:::

:::

::: {.soco-jc-links}
[Read the article](https://jitc.bmj.com/content/14/7/e015029){.soco-jc-link}
[PubMed](https://pubmed.ncbi.nlm.nih.gov/42476726/){.soco-jc-link .secondary}
...
Browse the papers discussed by the Society of Cutaneous Oncology, organized by year and meeting month.
