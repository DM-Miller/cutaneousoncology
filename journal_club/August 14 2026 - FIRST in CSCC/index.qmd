...
<style>
  ...
  @media (max-width:760px) {
    /*
      MOBILE LAYOUT
      Quarto's page is itself a CSS grid. The key fixes here are:
      1) allow the content grid item to shrink (min-width: 0);
      2) constrain every custom component to the viewport;
      3) use minmax(0,1fr) rather than bare 1fr for one-column grids.
    */
...
::: {.hero-copy}
A Journal Club discussion of response-guided immunotherapy, dose intensity, causal inference, and the central clinical question behind the paper: **what does another dose actually buy us?**
:::
