...
question_var <- "use_dermatoscope"
question_title <- "Do you regularly use a dermatoscope as part of your practice?"
...
dt <- dt |> 
  mutate(!!question_var := recode(.data[[question_var]], !!!dermatoscope_labels))
