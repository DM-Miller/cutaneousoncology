...
question_var <- "used_adjuvant_ici"
question_title <- "Have you ever recommended (or been part of a multi-disciplinary team recommending) adjuvant anti-PD1 immunotherapy for CSCC?"
