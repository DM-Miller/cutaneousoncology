...
question_var <- "tse_per_month"
question_title <- "How many Total Skin Exams do you perform per month?"
...
dt[[question_var]][dt[[question_var]] == "Greater Than-100"] <- "Greater than 100"
...
# Re-factor with correct ordering
response_summary <- dt |> 
